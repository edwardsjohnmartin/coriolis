...
function ArrowHelper( dir, origin, length, lineWidth, color, radialSegments, headLength, headWidth ) {
  ...
  if ( lineGeometry === undefined ) {
    ...
    coneGeometry = new THREE.CylinderBufferGeometry( 0, 0.5, 1, radialSegments, 1 );
